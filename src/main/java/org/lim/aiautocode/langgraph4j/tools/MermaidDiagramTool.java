package org.lim.aiautocode.langgraph4j.tools;
...
import org.lim.aiautocode.langgraph4j.model.ImageCategoryEnum;
...
public class MermaidDiagramTool {
    ...
    public List<ImageResource> generateMermaidDiagram(@P("Mermaid 图表代码") String mermaidCode,
        ...
        try {
            ...
            String cosUrl = oosManager.uploadFile(keyName, diagramFile);
            // 清理临时文件
